...
public class AddCategory extends AppCompatActivity {
    ...
    int finalColor;
    ListView mListView;
    public static ArrayList<Categories> cat2 = new ArrayList<>();
    ...
    public void dialog(View view) {
        ...
        dialog.setContentView(R.layout.add_cat_layout);
        ...
        dialog.findViewById(R.id.ok).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ok) {
                    MainActivity.cat.add(new Categories(name, finalColor));
                    cat2.add(new Categories(name, finalColor));
                    CatAdapter a = (CatAdapter) mListView.getAdapter();
                    ((TextView) findViewById(R.id.nb_cat)).setText("Categories (" + String.valueOf(cat2.size()) + ")");
                    a.notifyDataSetChanged();
                    dialog.dismiss();
