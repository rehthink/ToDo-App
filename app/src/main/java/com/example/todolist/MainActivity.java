...
public class MainActivity extends AppCompatActivity {
    ...
    public static ArrayList<Categories> cat = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CheckBox checkDone =  findViewById(R.id.switch_done);
        ...
        CheckBox checkPassed =  findViewById(R.id.switch_passed);
        ...
        getCatData();
        if (cat.size() == 0)
            cat.add(new Categories("none", Color.parseColor("#262D3B")));
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                String categorie = item.getCategories();
    ...
    public void getData() {
       ...
       public void getCatData() {
        ...
        while (count < resultSet.getCount()) {
            ...
            tmp = new Categories(name, Integer.parseInt(color));
            list.add(tmp);
            count++;
            resultSet.moveToNext();
        }
    ...
    public void addToList(Item item) throws ParseException {
        ...
        while (c < cat.size()) {
            if (item.getCategories().equals(cat.get(c).getName())) {
    ...
    public boolean showCatForItem(Item item) {
        int i = 0;
        while (i < cat.size()) {
            if (cat.get(i).getName().equals(item.getCategories())) {
    ...
    public static ArrayList<Categories> getCatA() {
    ...
    public static ArrayList<Categories> getCat() {
        return (getCatA());
    }
    ...
    public void checkCategories() {
        ...
        while (i < items.size()) {
            ...
            boolean found = false;
            while (c < cat.size()) {
                if (items.get(i).getCategories().equals(cat.get(c).getName()))
                    found = true;
                c++;
            }
            if (!found)
                items.get(i).setCategories("none");
            i++;
        }
        affListCorresponding();
    }
